...
function getErrorCopy(error: ApiError | null) {
  ...
  if (error?.code === 'FORBIDDEN') {
    return {
      title: 'Access denied',
      description: 'You do not have permission to view these analytics.',
    }
  }

  return {
    title: 'Could not load analytics',
    description: error?.message ?? 'Analytics could not be loaded. Try again.',
  }
}
...
export function LinkAnalyticsPage() {
  ...
  const errorCopy = getErrorCopy(blockingError)
